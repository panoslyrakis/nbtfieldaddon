...
class Simple_GF_Field extends GF_Field {
	...
	public function get_form_editor_field_title() {
		return esc_attr__( 'Blog Templates', 'nbtfieldaddon' );
	}
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		$input = do_shortcode( '[wpmudev_templates_list layout="screenshot"]' );
		//$input = do_shortcode( '[wpmudev_templates_list layout="screenshot"]' ) . "<input name='input_{$id}' id='{$field_id}' type='text' value='{$value}' class='{$class}' {$tabindex} {$logic_event} {$placeholder_attribute} {$required_attribute} {$invalid_attribute} {$disabled_text}/>";
